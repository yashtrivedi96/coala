...
If a part or even most of what you just read made little sense to you, just
...
..note::
    ...
    Go to http://coala.io/review to find all PRs that are awaiting reviews.
...
.. seealso::
    ...
    `Review Process <http://coala.io/reviewing>`_.
...
After creating your ``Pull Request``, it is under the review process.
This can be deduced from the ``process/pending review`` label.
Now you have to go to http://coala.io/review and do a review yourself to receive
one yourself.
